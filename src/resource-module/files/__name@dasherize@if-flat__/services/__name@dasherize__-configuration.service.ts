...
import { <%= classify(name) %>ModuleConfig } from "../role.config";
import { MODULE_CONFIG_TOKEN, MODULE_DEFAULT_CONFIG } from "../role.config";
import { <%= classify(name) %>State } from "../role.reducers";
